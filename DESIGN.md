...
- **Seed color:** `#8079b4` (used to derive `ColorScheme` via `ColorScheme.fromSeed` where applicable).
...
Import tokens via `package:trivia_pulse/src/theme/theme_constants.dart`.
