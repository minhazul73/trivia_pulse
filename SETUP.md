...
### Code Generation
Your stack relies on code generation (Hive Adapters, Firebase, etc.). Run the following command right away to generate the necessary files:
```bash
